        ...
        <i onClick={handleNav} className='fa-solid fa-bars sm:hidden text-[--accent] text-4xl'></i>
        {
          ...
          <nav className='sm:block hidden'>
            <ul className='flex gap-[2.5em] text-[var(--text)]'>
                <li className='text-[1em] items-center cursor-pointer hover:border-b-[2px] border-[--accent] roboto font-bold uppercase'>Home</li>
                <li className='flex gap-[.5em] text-[1em] items-center cursor-pointer hover:border-b-[2px] border-[--accent] roboto font-bold uppercase'>Projects <i className='fa-solid animate-bounce fa-caret-left text-[--accent]'></i></li>
                <li className='text-[1em] items- cursor-pointer hover:border-b-[2px] border-[--accent] roboto font-bold uppercase'>About </li>
                <li className='flex items-center gap-[.5em] text-[1em] items- cursor-pointer hover:border-b-[2px] border-[--accent] roboto font-bold uppercase'>Contact <i className='fa-solid animate-bounce fa-caret-left text-[--accent]'></i></li>
                <li className='flex items-center gap-[.5em] text-[1em] items- cursor-pointer hover:border-b-[2px] border-[--accent] roboto font-bold uppercase'> Skills <i className='fa-solid animate-bounce fa-caret-left text-[--accent]'></i></li>
            </ul>
          </nav>
          </>
