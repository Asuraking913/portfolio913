          ...
          <>
            <nav className='h-screen  bg-[--accent] fixed top-0 w-full left-0'>
              ...
              <ul className='flex flex-col items-center justify-center gap-[2.5em] text-[--accent] h-screen'>
                  <li onClick={handleClick} className='w-[200px] active:scale-110 flex duration-[.1s] rounded-[2em] shadow-lg shadow-black active:shadow-[#00000062] justify-center py-[1em] px-[1.5em] bg-white text-[1em] items- cursor-pointer roboto font-bold uppercase'>Home</li>
                  <li onClick={() => (handleClick1('proj'))} className='w-[200px] active:scale-110 flex duration-[.1s] rounded-[2em] shadow-lg shadow-black active:shadow-[#00000062] justify-center py-[1em] px-[1.5em] bg-white  items-center gap-[.5em] text-[1em] items- cursor-pointer roboto font-bold uppercase'>Projects <i className='fa-solid fa-caret-left text-[--accent]'></i></li>
                  <li onClick={() => (handleClick1('about'))} className='w-[200px] active:scale-110 flex duration-[.1s] rounded-[2em] shadow-lg shadow-black active:shadow-[#00000062] justify-center py-[1em] px-[1.5em] bg-white text-[1em] items- cursor-pointer roboto font-bold uppercase'>About </li>
                  <li onClick={() => (handleClick1('foot'))} className='w-[200px] active:scale-110 flex duration-[.1s] rounded-[2em] shadow-lg shadow-black active:shadow-[#00000062] justify-center py-[1em] px-[1.5em] bg-white items-center gap-[.5em] text-[1em] items- cursor-pointer roboto font-bold uppercase'>Contact <i className='fa-solid fa-caret-left text-[--accent]'></i></li>
                  <li onClick={() => (handleClick1('skill'))} className='w-[200px] active:scale-110 flex duration-[.1s] rounded-[2em] shadow-lg shadow-black active:shadow-[#00000062] justify-center py-[1em] px-[1.5em] bg-white items-center gap-[.5em] text-[1em] items- cursor-pointer roboto font-bold uppercase'> Skills <i className='fa-solid fa-caret-left text-[--accent]'></i></li>
              </ul>
            </nav>
          </>
        }
