    ...
    <>
      <section className='sm:px-[--padx] min-[300px]:px-[--padx1] flex items-center min-[300px]:h-[100vh] sm:h-screen justify-between'>
            <div className='flex gap-[0.5em] flex-col'>
              ...
              <button onClick={handleDownload} className='p-[1em] hover:bg-[--accentH] duration-[1s] rounded-[5px] px-[.5em] bg-[--accent] w-[40%] text-white roboto font-semibold textxl'>Download CV</button>
            </div>
      ...
      <section id='about' className='sm:h-[100vh] min-[300px]:h-[full] flex items-center justify-between min-[300px]:px-[--padx1] sm:px-[--padx]'>
      ...
      <section id='proj' className='flex flex-col gap-[3em] justify-center py-[4em] items-center sm:px-[--padx] min-[300px]:px-[padx1]'>
