          ...
          <div className='flex gap-[.5em]'>
            <span className='poppins text-nowrap font-bold text-[--accent] text-xl'>Follow me:</span> <div className='flex gap-[.5em] items-center'>
              <i className='fa-brands animate-pulse hover:scale-125 duration-[0.5s] text-xl fa-facebook text-blue-600'></i>
                          <i className='fa-brands animate-pulse hover:scale-125 duration-[0.5s] hover:animate-none text-xl fa-linkedin text-blue-600'></i>
                          <i className='fa-brands animate-pulse hover:animate-none hover:scale-125 duration-[0.5s] text-xl fa-x-twitter text-black'></i>
                          <i className='fa-brands animate-pulse hover:animate-none hover:scale-125 duration-[0.5s] text-xl fa-whatsapp text-green-600'></i>
                          <i className='fa-brands animate-pulse hover:scale-125 duration-[0.5s] text-xl fa-github text-[--text] hover:animate-none'></i>
            </div>
          </div>
          </div>
        </div>
