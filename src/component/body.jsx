    ...
    <>
      <section className='px-[--padx] flex items-center h-screen justify-between'>
            <div className='flex gap-[0.5em] flex-col'>
              ...
              <button className='p-[1em] rounded-[5px] px-[1.5em] bg-[--accent] w-[40%] text-white roboto font-semibold textxl'>Download CV</button>
            </div>
      ...
      <section className='h-[40vh] flex items-center justify-between px-[--padx]'>
        ...
        <div className='w-[50%] p-[2em]'>
          <img src={myImage2} className='h-[500px] w-[400px] rounded-bl-[12em] rounded-br-[15em] object-cover' alt="" />
        </div>
        <div className='w-[60%]'>
