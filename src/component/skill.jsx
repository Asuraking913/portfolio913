...
function Skill({h3, p}) {
    ...
    {
        return (
            <div className='sm:w-[350px] duration-[0.4s] min-[300px]:w-[100%] text-center px-[3em] rounded-[.5em] boxSha items-center justify-center p-[1em] bg-[--accent] flex flex-col gap-[.5em]'>
        ...
        return (
          <div className='sm:w-[350px] sm:h-[220px] duration-[0.4s] min-[300px]:w-[100%] text-center px-[1em] boxSha rounded-[1em] items-center justify-between p-[1em] flex flex-col '>
